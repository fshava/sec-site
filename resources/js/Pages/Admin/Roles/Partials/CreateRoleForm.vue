...
<template>
    <section>
        ...
        <form @submit.prevent="form.post(route('roles.store'))" class="mt-6 space-y-6">
            <div>
                            ...
                            <table class="min-w-full text-center">
                                ...
                                <tbody>
                                    <tr v-for="permission in permissions" class="bg-white border-b">
                                        <td>
                                            <Checkbox @click="addPermission(permission.name)" type="checkbox" :value="permissions.name" :name="permission[permissions.name]" />
